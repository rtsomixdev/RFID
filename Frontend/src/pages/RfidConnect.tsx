                        ...
                        <CardContent sx={{ p: 3 }}>
                            ...
                            <Grid container spacing={3} alignItems="center" sx={{ mb: 4, p: 3, bgcolor: isEditingReader ? '#fff7ed' : '#f8fafc', borderRadius: 2, border: '1px solid #e2e8f0' }}>
                                ...
                                <Grid size={{ xs: 12, md: 6 }}>
                                    <TextField
                                        fullWidth label="ชื่อจุดติดตั้ง (Reader Name)" placeholder="ex: ประตูทางออก 1"
                                ...
                                <Grid size={{ xs: 12, md: 6 }}>
                                    <TextField
                                        fullWidth label="IP Address (ESP32)" placeholder="192.168.x.x"
                                ...
                                <Grid size={{ xs: 12, md: 6 }} sx={{ display: 'flex', gap: 2 }}>
                                    ...
                                    <Button
                                        ...
                                        sx={{ height: 44 }} // Match input height
                                    >
